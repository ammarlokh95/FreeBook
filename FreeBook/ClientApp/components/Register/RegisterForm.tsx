...
import { userConstants } from 'ClientApp/_constants';
import { LoginForm } from 'ClientApp/components/Login/LoginForm';
            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <a onClick={() => { return <LoginForm /> }} className="btn btn-link">Cancel</a>
                    </div>
                </form>
            </div>
        );
